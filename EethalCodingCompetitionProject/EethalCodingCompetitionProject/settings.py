"""
Django settings for EethalCodingCompetitionProject project.
...
ROOT_URLCONF = 'EethalCodingCompetitionProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['VolunteerReportingApp/templates/html'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'EethalCodingCompetitionProject.wsgi.application'
